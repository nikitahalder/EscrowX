...
pub fn project_created(env: &Env, project_id: u64, client: &Address, freelancer: &Address, amount: i128) {
...
pub fn milestone_submitted(env: &Env, project_id: u64, milestone_id: u32, proof_hash: &soroban_sdk::String) {
...
pub fn dispute_raised(env: &Env, project_id: u64, raised_by: &Address, milestone_id: u32) {
    ...
    env.events().publish(topics, (raised_by.clone(), milestone_id));
}
